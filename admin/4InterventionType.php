...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <!-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class=" mb-0 text-gray-800 fw-bolder">Intervention Type Management</h1>
            </div> -->
                ...
                <div class="card-header py-3" style="background-color: #0D7C66;">
                    ...
                    <div class="d-flex align-items-center">
                        <button type="button" class="btn d-flex align-items-center gap-2 rounded-pill shadow-sm"
                            ...
                            id="btnAddInterventionType" data-bs-toggle="modal" data-bs-target="#addInterventionTypeModal">
                        ...
                        <form class="d-none d-sm-inline-block form-inline ml-auto my-2 my-md-0 mw-100 navbar-search custom-search-form">
                            <div class="input-group">
                                ...
                                placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2" onkeyup="searchIntTypeTable()">
                    ...
                    <div class="card-body">
                        <div style="max-height: 430px; overflow: auto; width: 100%; border: 1px solid #ddd; border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);">
                            <table class="table table-bordered text-center" width="100%" cellspacing="0">
                                ...
                                <tbody id="dataTable4" style="color: black;">
                                    <?php
                                        ...
                                        // Count total records
                                        $countQuery = $conn->prepare("SELECT COUNT(*) FROM tbl_intervention_type WHERE station_id = ?");
    ...
    ?>
    <?php include 'modals/modal_for_intervention_type.php'; ?>

<script>
        document.addEventListener("DOMContentLoaded", function () {
    const searchInput = document.getElementById("search_id");
    const searchButton = document.querySelector(".input-group-append button"); // Search button
    const dataTable = document.getElementById("dataTable4"); // Table body
    ...
    function fetchSearchResults() {
        ...
        if (query === "") {
            location.reload(); // Reload the page to show all data when search is empty
            return;
        }

        fetch("4InterventionTypeManagement/searchInterventionType.php? q=" + encodeURIComponent(query))
